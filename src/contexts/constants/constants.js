...
export const WEBSITE_NAME = "Dandela Academy";
export const WEBSITE_LOCATION = "Zango III, Luanda, Angola";
export const WEBSITE_SCHEDULE = "Segundas - sábados 8h - 18h";
export const WEBSITE_PHONE_NUMBER = "+244 974 502 709";
export const WEBSITE_WHATSAPP = "+244 955 872 494";
export const WEBSITE_TIKTOK = "https://vm.tiktok.com/ZMHn9uKSCcKLV-9Y6mP/";
export const WEBSITE_TWITTER= "";
export const WEBSITE_INSTAGRAM = "";
export const WEBSITE_LINKEDIN = "https://www.linkedin.com/in/dandela-academia-b20b03352";
export const WEBSITE_FACEBOOK = "https://m.facebook.com/61573515662248/";
export const WEBSITE_TELEGRAM = "";
export const WEBSITE_EMAIL_INFO = "info@academy.dandela.com";
export const WEBSITE_EMAIL_NO_REPLY = "no-reply@academy.dandela.com";
export const WEBSITE_START_YEAR = 2024;
export const LINK_GROK = "https://grok.com/";
export const LINK_CHAT_GPT = "https://chatgpt.com/";
export const LINK_GEMINI = "https://gemini.google.com/app";

export const LINK_DANDELA_ACADEMY = process.env.NEXT_PUBLIC_WEBSITE_LINK;
export const LINK_INEFOP = "https://www.inefop.gov.ao/auth/home";
//export const LINK_GROK = "https://grok.com/";
