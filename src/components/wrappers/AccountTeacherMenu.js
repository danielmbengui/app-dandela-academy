...
import { IconDownloadDesktopApp, IconDownloadMobileApp, IconDropDown, IconSettings } from '@/assets/icons/IconsComponent';
import { useUserDevice } from '@/contexts/UserDeviceProvider';
import { usePwa } from '@/contexts/PwaProvider';
import { usePathname } from 'next/navigation';
import { PAGE_SETTINGS } from '@/contexts/constants/constants_pages';
...
export default function AccountTeacherMenu() {
  ...
  return (
    <>
      ...
      <Menu
        ...
        onClose={handleClose}
        onClick={(e) => {
          // Ne pas fermer si on clique sur le menu de langue
