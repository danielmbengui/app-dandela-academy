"use client";
import { PAGE_TERMS_PRIVACY } from "@/contexts/constants/constants_pages";
import { NS_TERMS_USAGE } from "@/contexts/i18n/settings";
        ...
        <main className="container">
            <nav className="breadcrumb-nav">
                <Typography sx={{ color: 'var(--font-color)', fontSize: '0.875rem' }}>
                    {t('title')}{" / "}
                    <Link href={PAGE_TERMS_PRIVACY} className="breadcrumb-link">
                        {t('title-privacy')}
                    </Link>
                </Typography>
            </nav>
