...
import MobileMenuItemsHomeOB from "./MobileItemsHomeOB";
...
import MobileMenuCloseOB from "../../MobileMenuCloseOB";
import MobileSocialOB from "../../MobileSocialOB";
import SelectLangOB from "../../SelectLangOB";
import { usePathname } from "next/navigation";
import { useAuth } from "@/contexts/AuthProvider";
import LoginButtonOB from "../../LoginButtonOB";

const MobileMenuHomeOB = () => {
  const { user } = useAuth();
...
export default MobileMenuHomeOB;
