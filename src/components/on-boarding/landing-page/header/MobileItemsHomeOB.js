  ...
  return (
    <div className="pt-8 pb-6 border-b border-borderColor dark:border-borderColor-dark">
      <AccordionContainerOB>
        {items.map((item, idx) => (
          <MobileMenuItemHomeOB key={idx} item={item} />
        ))}
      </AccordionContainerOB>
    </div>
  );
...
export default MobileMenuItemsHomeOB;
