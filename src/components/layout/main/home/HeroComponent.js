  ...
  const slides = [
    {
      title: (
        <>
          {`Commencez votre apprentissage avec le meilleur centre professionnel`}
        </>
      ),
    ...
    },
    {
      title: (
        <>
          {`Formation et conseil de haute qualité`}
        </>
      ),
      tag: "Career Solution",
    },
    {
      title: (
        <>
          {`Développez votre carrière de la meilleure façon`}
        </>
      ),
...
const HeroComponent = () => {
  console.log("HOME_STUDENT",universityImage1)
  console.log("HOME_STUDENT import",IMAGE_HOME_SCHOOL_2)
  return (
