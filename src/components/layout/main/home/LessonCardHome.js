...
import { IMAGE_HOME_LESSON_1, IMAGE_HOME_LESSON_2, IMAGE_HOME_LESSON_3, IMAGE_HOME_TUTOR_AFONSO } from "@/libs/constants/constants_images";
import { PAGE_WAITING_LIST } from "@/libs/constants/constants_pages";
import { NS_BUTTONS, NS_HOME, NS_LEVELS, NS_ROLES } from "@/libs/i18n/settings";
import { Button, Grid, Stack, Typography } from "@mui/material";
import Image from "next/image";
import Link from "next/link";
import React, { useEffect } from "react";
import { useTranslation } from "react-i18next";
import { FaPhone, FaWhatsapp, FaMailBulk, FaFacebook, FaInstagram, FaTwitter, FaLocationArrow, FaClock } from 'react-icons/fa';
import { IconCertificate, IconEmail, IconLevel, IconProfile } from "@/assets/icons/IconsComponent";
...
const LessonCardHome = ({ course, type}) => {
  ...
  console.log("TEST tutor", certified_text)
  return (
    <div
            ...
            <div className="relative mb-2">
              ...
              <div className="absolute left-0 top-1 flex justify-between w-full items-center px-2">
                ...
                <button
                  ...
                  className="hidden text-white bg-black bg-opacity-15 rounded hover:bg-primaryColor"
                >
