"use client";
import { IconEmail, IconProfile, IconTiktok } from "@/assets/icons/IconsComponent";
import useIsTrue from "@/hooks/useIsTrue";
import { WEBSITE_EMAIL_INFO, WEBSITE_FACEBOOK, WEBSITE_LINKEDIN, WEBSITE_LOCATION, WEBSITE_PHONE_NUMBER, WEBSITE_TIKTOK, WEBSITE_WHATSAPP } from "@/libs/constants/constants";
import { Stack } from "@mui/material";
import Link from "next/link";
import React from "react";
import { FaPhone, FaWhatsapp, FaMailBulk, FaFacebook, FaInstagram, FaTwitter, FaLocationArrow, FaLinkedin, FaTiktok } from 'react-icons/fa';
const HeaderTop = () => {
