...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "blue-x-light": "#e9ecef",
                orange: "#ed6c02",
        "orange-light": "rgba(237, 108, 2, 0.25)",
        "black-brerry-light": "rgba(114, 106, 137, 0.8)",
        bodyColor: "#222222",
        fontColor: "var(--font-color)",
        fontReverseColor: "var(--font-reverse-color)",
        bodyBg: "var(--background)",
        menuBg:"var(--background-menu)",
        footerBg:"var(--background-footer)",
        bodyBg1: "#F7F7F7",
        whiteColor: "#ffffff",
        whitegrey: "#6A7C92",
        whitegrey1: "#EDEDED",
        ...
        blackColor2: "var(--primaryColor)",
        darkblack: "var(--blue-dark)",
        darkcolor: "#263546",
        darkgray: "#9FA2CE",
        deepgray: "#202942",
        lightGrey: "#7B8696",
      ...
      animation: {
        ...
        preloader: "preloader 100.5s linear 0.5s",
      },
    },
  },
  // components
  ...
  plugins: [
    ...
    function ({ addComponents }) {
      ...
      addComponents({
        ".fixed-shadow": {
          backgroundImage: "linear-gradient(45deg, var(--secondaryColor), var(--primaryColor))",
          position: "fixed",
          top: "200px",
          right: "auto",
          bottom: "auto",
